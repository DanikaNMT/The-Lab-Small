...
import ToyCard from "@/components/5. Perplexity/productCardPerplexity.tsx";
import { useNavigate } from "react-router-dom";

export function ProductScreenPerplexity() {
        ...
        <div className="flex flex-col w-screen h-screen gap-4 p-4 bg-gradient-to-b from-blue-100 to-purple-200">
            ...
            <div className="flex-1 flex flex-wrap justify-center gap-8 mt-6">
                {products.map((product: Product) => (
                    <ToyCard product={product} key={product.id} />
                ))}
            </div>
...
export default { ProductScreenPerplexity };
